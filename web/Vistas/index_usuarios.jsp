<%-- 
    ...
    Created on : 15 oct. 2023, 00:37:10
    Author     : OSCAR QUISPE 
--%>
...
<section class="content" style="padding-left: 10px;padding-right: 10px;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-3">
                <a type="button" href="cUsuario?accion=new_usuario" target="FramePrincipal" class="btn btn-primary btn-block mb-3" title="Click para Registrar Nueva Mesa" onclick="">
                    Registrar Usuario
                </a>
                <div class="card">
            ...
            <div class="col-md-9">
                <div class="card card-primary">
                    <div class="alert alert-primary" role="alert">
                        <i class="fas fa-th"></i>
                        <b style="color: #004085;"> MENU PRINCIPAL - LISTADO DE USUARIOS </b>
                    </div>
                    ...
                    <div class="col-xl-12 col-sm-12 col-md-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-sm" style="width: 100%;
                                                                            ...
                                                                            cursor: pointer;
                                                                            text-align: center;
                                                                            text-transform: uppercase;" id="tblRegistroUsuarios">
                                ...
                                <tbody class="text-primary text-left" style="text-align: center !important;">
                                    ...
                                    <tr>
                                        <td>${usu.getUsu_id()}</td>
                                        <td>${usu.getUsu_alias()}</td>
                                        <td>${usu.getUsu_contra()}</td>
                                        <td>${usu.getUsu_dni()}</td>
                                        <td>${usu.getUsu_datos()}</td>
                                        <td>${usu.getUsu_direccion()}</td>
                                        <td>${usu.getUsu_fono()}</td>
                                        <td>${usu.getUsu_nombrerol()}</td>
                                        <c:if test="${usu.getUsu_estado()==1}">
                                            <td><span class="badge badge-pill badge-success">Activo</span></td>
                                        </c:if>
                                        <c:if test="${usu.getUsu_estado()==0}">
                                            <td><span class="badge badge-pill badge-danger">Inactivo</span></td>
                                        </c:if>
                                        <td>
                                            <a href="#" title="Click para Editar" onclick=""><i class="fas fa-edit text-warning"></i></a>
                                        </td>
                                    </tr>
                                    </c:forEach>
                                </tbody>
